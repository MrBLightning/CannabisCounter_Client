...
export class SibaAuths extends Component<SibaAuthsProps> {
    dataGrid: any | null = null;
    dataLoading: boolean = false;
    state: SibaAuthsState = {
        sibares: [],
        sibas: [],
        sibaFiltered: [],
        // initial filter value to Auth - siba code 4
        filterValue: 4,
            ...
            <div className='grid-wrapper'>
                {/* <div className='grid-header'>
                    <div className='container'>
                        <div className='header-text'>{"ניהול מאשרים"}</div>
                    </div>
                </div> */}
                    ...
                    <div className='container'>
                        ...
                        >
                            ...
                            <Editing
                                ...
                                />
                                <Popup title={'מאשר'} showTitle={true} width={350} height={210}>
                                </Popup>
                                <Form>
                                    <Item itemType={'group'} >
