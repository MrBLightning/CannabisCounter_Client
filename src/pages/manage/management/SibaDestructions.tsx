...
type SibaDestructionsProps = {
    permission: RbacPermission;
} & RouteComponentProps;
type SibaDestructionsState = {
    sibares: SibaRes[],
    sibas: Siba[],
    sibaFiltered: Siba[],
    filterValue: number,
...
export class SibaDestructions extends Component<SibaDestructionsProps> {
    dataGrid: any | null = null;
    dataLoading: boolean = false;
    state: SibaDestructionsState = {
        sibares: [],
        sibas: [],
        sibaFiltered: [],
        // initial filter value to destruction - siba code 1
        filterValue: 1,
            ...
            <div className='grid-wrapper'>
                {/* <div className='grid-header'>
                    <div className='container'>
                        <div className='header-text'>{"סיבות השמדה"}</div>
                    </div>
                </div> */}
                    ...
                    <div className='container'>
                        ...
                        >
                            ...
                            <Editing
                                ...
                                />
                                <Popup title={'עדכון סיבות השמדה'} showTitle={true} width={350} height={210}>
                                </Popup>
                                <Form>
                                    <Item itemType={'group'} >
