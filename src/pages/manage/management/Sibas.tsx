...
export class Sibas extends Component<SibasProps> {
    ...
    state: SibasState = {
        ...
        sibas: [],
        sibaFiltered: [],
        // initial filter value to approvers - siba code 4
        filterValue: 4,
    ...
    onRowInserted(e: any) {
        this.addSiba(e.Siba, e.Description).then(() => {
    ...
    onRowUpdated(e: any) {
        this.updateSiba(e.Id, e.Siba, e.Description).then(() => {
            ...
            <div className='grid-wrapper'>
                {/* <div className='grid-header'>
                    <div className='container'> */}
                        {/* <div className='header-text'>{"ניהול " + this.state.sibares.filter(record => record.Id === this.state.filterValue)[0].Name}</div> */}
                        {/* <div className='header-text'>{"ניהול סיבה/מאשר"}</div>
                    </div>
                </div> */}
                    ...
                    <div className='container'>
                        ...
                        >
                            ...
                            <Editing
                                ...
                                />
                                {/* <Popup title={'עדכון ' + this.state.sibares.filter(record => record.Id === this.state.filterValue)[0].Name} showTitle={true} width={350} height={600}> */}
                                <Popup title={'עדכון סיבה/מאשר'} showTitle={true} width={350} height={210}>
                                </Popup>
                                <Form>
                                    <Item itemType={'group'} >
