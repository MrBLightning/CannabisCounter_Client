...
type SibaConversionsProps = {
    permission: RbacPermission;
} & RouteComponentProps;
type SibaConversionsState = {
    sibares: SibaRes[],
    sibas: Siba[],
    sibaFiltered: Siba[],
    filterValue: number,
...
export class SibaConversions extends Component<SibaConversionsProps> {
    dataGrid: any | null = null;
    dataLoading: boolean = false;
    state: SibaConversionsState = {
        sibares: [],
        sibas: [],
        sibaFiltered: [],
        // initial filter value to Conversion - siba code 3
        filterValue: 3,
            ...
            <div className='grid-wrapper'>
                {/* <div className='grid-header'>
                    <div className='container'>
                        <div className='header-text'>{"סיבות המרה"}</div>
                    </div>
                </div> */}
                    ...
                    <div className='container'>
                        ...
                        >
                            ...
                            <Editing
                                ...
                                />
                                <Popup title={'עדכון סיבות המרה'} showTitle={true} width={350} height={210}>
                                </Popup>
                                <Form>
                                    <Item itemType={'group'} >
