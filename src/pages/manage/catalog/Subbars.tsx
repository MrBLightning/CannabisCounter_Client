...
import { getCatalogItems, getSubbars, addSubbar, updateSubbar, deleteSubbar } from 'shared/api/subbar.provider';
...
export class Subbars extends Component<SubbarsProps> {
